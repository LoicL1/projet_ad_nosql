...
spark = SparkSession.builder.appName("StructuredStreamingKafkaMongoDB").config("spark.mongodb.output.uri", "mongodb://mongo:27017/logs.status_sort_by_ip").getOrCreate()
